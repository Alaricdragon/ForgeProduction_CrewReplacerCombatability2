...
public class BreakdownLogic {
    ...
    public void calculateBreakdowns(CampaignFleetAPI fleet) {
        ...
        if (breakdownHappened && totalDailyMachineryUsed > 10) {
            ...
            Forgeprod_DefaultCargo.active.removeCommodity(Forgeprod_DefaultCargo.TYPE_BASE_REQUIRED,Commodities.HEAVY_MACHINERY, dailyMachineryBroken,fleet.getCargo());
    ...
    private void calculateFatalAccidents(CampaignFleetAPI fleet) {
        ...
        Forgeprod_DefaultCargo.active.removeCommodity(Forgeprod_DefaultCargo.TYPE_BASE_REQUIRED,Commodities.CREW,dailyCrewmenLost,fleet.getCargo());//fleet.getCargo().removeCommodity(Commodities.CREW, dailyCrewmenLost);
